...
def add_missing_widths():
    """Add all supported widths for each product"""
    ...
    try:
        ...
        for product_name in products:
            ...
            # Remove 'Custom' from widths to add (we don't create database entries for Custom)
            widths_to_check = [w for w in SUPPORTED_WIDTHS if w != "Custom"]
